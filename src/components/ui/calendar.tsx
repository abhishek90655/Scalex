    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white/10 border-white/20 p-0 opacity-70 hover:opacity-100"
        ),
        ...
        day_selected:
          "bg-scalex-blue text-white hover:bg-scalex-blue hover:text-white focus:bg-scalex-blue focus:text-white rounded-md border-0",
        day_today: "text-accent-foreground font-bold border border-scalex-lightBlue rounded-md",
        day_outside:
